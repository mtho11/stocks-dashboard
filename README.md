...
- **Historical date picker** — pick any past date back to 2024-01-01 and every metric, sparkline, and RS rank is recalculated for that date. Data is generated with a Mulberry32 PRNG seeded by `date × ticker`, so any stock+date pair always produces the same values
